// Supongamos que tienes un JSON llamado 'data' con un array de objetos
const data = [
    {
      "id": 1,
      "key": "001",
    ...
    },
    {
      ...
      "aura": {
        "name": "Heart Drain",
        "description": "Heart Drain - While fighting together, grants the player and Lovander the life steal effect which absorbs some of the received damage and restores HP."
      },
...
// Array para almacenar los valores de la clave "drops"
let dropValues = {};

// Iterar sobre cada objeto en el array "data" y guardar los valores de la clave "drops"
data.forEach(obj => {
    // console.log(obj.drops);
    obj.drops.forEach(drop => {
        dropValues[drop] = drop;
    });
